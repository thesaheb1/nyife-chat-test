...
const organizationScopedRoutes = [
  ...
  { path: 'campaigns/:id/edit', element: guardedLazyElement('organization', 'campaigns', 'update', CreateCampaignPage) },
    ...
    children: [
      { path: '/force-change-password', element: <ForceChangePasswordPage /> },
      {
        ...
        children: [
          ...
          { path: '/campaigns/:id/edit', element: <OrganizationPathRedirect /> },
          ...
          { path: '/organizations', element: guardedLazyElement('organization', 'organizations', 'read', OrganizationsPage) },
          { path: '/organizations/:id', element: guardedLazyElement('organization', 'organizations', 'read', OrgDetailPage) },
