          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(260px,0.85fr)]">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Keep the essentials visible before you go deeper into the builder.</CardDescription>
              </CardHeader>
            ...
            <Card className={templateLimitReached ? 'border-destructive/40 bg-destructive/5' : undefined}>
              <CardHeader className="pb-3">
                <CardTitle className="text-lg">Subscription</CardTitle>
                <CardDescription>Keep template usage and plan headroom in view while you build.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 pt-0">
                <div className="flex flex-wrap items-center gap-2">
